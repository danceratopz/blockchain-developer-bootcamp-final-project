  ...
  return (
    <FractFieldset>
      <legend style={{ float: "left" }}>
        About - NFT Fractionalizer and Market
      </legend>
      ...
      {!active &&
        (<NoFractFieldset>
          ...
          {window.ethereum &&
            <StyledDiv>
              <Text t4 center>
                To explore the UI and interact with the contract please change to the <b>Ropsten Test Network</b> in Metamask and hit <b>Connect</b>.
              </Text>
            </StyledDiv>}
        </NoFractFieldset>)}
      <p>
      ...
      <ul>
        <li key="paradigm">
          <StyledAnchor href="https://faucet.paradigm.xyz/" target="blank">faucet.paradigm.xyz</StyledAnchor> drips
          both test Ether and NFTs (requires Twitter sign-in).
        </li>
        <li key="faucetbe">
          <StyledAnchor href="https://faucet.ropsten.be/" target="blank">faucet.ropsten.be</StyledAnchor> drips test Ether.
        </li>
      </ul>
      <p>
        Otherwise, feel free to contact me <StyledAnchor href="https://github.com/danceratopz">(Github profile)</StyledAnchor> with your Ropsten
        address and I'll send you some test Ether or NFTs.
      </p>
      <p>
        This dapp was created as the Final Project for the <StyledAnchor href="https://consensys.net/bootcamp">ConSensys Blockchain Bootcamp 2021</StyledAnchor>:{' '}
        the contract and frontend source are available on <StyledAnchor href="https://github.com/danceratopz/blockchain-developer-bootcamp-final-project">Github</StyledAnchor>: the contract is deployed at{' '}
